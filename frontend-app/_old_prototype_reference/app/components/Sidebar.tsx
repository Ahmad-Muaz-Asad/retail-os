...
export default function Sidebar() {
    ...
    return (
        <aside className="flex flex-col w-14 md:w-56 shrink-0 h-screen sticky top-0 bg-white dark:bg-neutral-900 border-r border-neutral-200 dark:border-neutral-800 z-40 transition-all">
            ...
            {/* Footer */}
            <div className="px-3 py-3 border-t border-neutral-200 dark:border-neutral-800 shrink-0">
                <div className="flex items-center gap-2.5">
                    ...
                    <div className="hidden md:block min-w-0">
                        ...
                        <p className="text-[10px] text-neutral-400 dark:text-neutral-500 truncate">v1.0.0</p>
                    </div>
                </div>
            </div>
        </aside>
